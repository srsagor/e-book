        ...
        <li class="c-header-nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right pt-0">
                ...
                <a class="dropdown-item" href="#">
                    <i class="c-icon cil-bell"></i>&nbsp;
                    @lang('Notifications') <span class="badge badge-danger ml-auto">0</span>
                </a>
    ...
    <div class="c-subheader justify-content-between px-3">
        ...
        <div class="c-subheader-nav d-md-down-none mfe-2">
            <span class="c-subheader-nav-link">
                @if(\Illuminate\Support\Facades\Route::currentRouteName()=='backend.dashboard')
                    <div class="input-group btn-group">
                        <input class="form-control date-range-picker" type="text" name="daterangepicker"
                               id="dashboard-daterange" placeholder="{{__("Enter Date")}}">
                        <div class="input-group-append">
                            <span class="input-group-text" id="dashboard-daterange-group">
                                <a id="daterange-reset-btn" class="daterange-reset-btn btn-icon" style="cursor: pointer;">
...
$(function () {
    if (document.body.contains(document.getElementById("liveClock"))){
        // Show the time
        showTime();
    }
})
